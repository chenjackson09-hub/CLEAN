...
describe('ApplicationCard', () => {
  it('renders applicant name, bio, address and submitted date', () => {
    render(<ApplicationCard application={baseApplication} onUpdateStatus={jest.fn()} />)
  ...
  it('renders both badge when application has residential + commercial', () => {
    render(<ApplicationCard application={{ ...baseApplication, service_types: ['residential', 'commercial'] }} onUpdateStatus={jest.fn()} />)
  ...
  it('calls onUpdateStatus with "approved" when Approve is clicked', async () => {
    ...
    render(<ApplicationCard application={baseApplication} onUpdateStatus={onUpdateStatus} />)
  ...
  it('does not render Approve/Reject buttons for approved applications', () => {
    render(<ApplicationCard application={{ ...baseApplication, status: 'approved' }} onUpdateStatus={jest.fn()} />)
  ...
  it('does not render Approve/Reject buttons for rejected applications', () => {
    render(<ApplicationCard application={{ ...baseApplication, status: 'rejected' }} onUpdateStatus={jest.fn()} />)

    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="email" className="px-3 block text-sm font-medium text-gray-700 mb-1">{t("auth.register.email")}</label>
            <input
              id="email"
              type="email"
              name="email"
              ...
              required
              disabled={loading}
              className="w-full border border-gray-300 rounded-2xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-50 disabled:text-gray-400"
            />
          </div>
          <div>
            <label htmlFor="password" className="px-3 block text-sm font-medium text-gray-700 mb-2">{t("auth.register.password")}</label>
            <input
              id="password"
              type="password"
              name="password"
